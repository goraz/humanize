...
func TestFunctionData(t *testing.T) {
	Convey("Function parser test", t, func() {
		...
		Convey("Fact about NoParam", func() {
			...
			So(len(fn.Parameters), ShouldEqual, 0)
			So(len(fn.Results), ShouldEqual, 0)
		...
		Convey("Fact about NoReturn", func() {
			...
			So(fn.Reciever, ShouldBeNil)
			So(len(fn.Parameters), ShouldEqual, 5)
			So(len(fn.Results), ShouldEqual, 0)
			So(fn.Parameters[0].Name, ShouldEqual, "a")
			So(fn.Parameters[0].Type.(IdentType).Ident, ShouldEqual, "int")
			So(fn.Parameters[1].Name, ShouldEqual, "b")
			So(fn.Parameters[1].Type.(IdentType).Ident, ShouldEqual, "string")
			So(fn.Parameters[2].Name, ShouldEqual, "c")
			So(fn.Parameters[2].Type.(IdentType).Ident, ShouldEqual, "int64")
			So(fn.Parameters[3].Name, ShouldEqual, "d")
			So(fn.Parameters[3].Type.(IdentType).Ident, ShouldEqual, "int64")
			So(fn.Parameters[4].Name, ShouldEqual, "_")
			So(fn.Parameters[4].Type.(IdentType).Ident, ShouldEqual, "bool")
		})
		...
		Convey("Fact about OneReturn", func() {
			...
			So(fn.Reciever, ShouldBeNil)
			So(len(fn.Parameters), ShouldEqual, 0)
			So(len(fn.Results), ShouldEqual, 1)
			So(fn.Results[0].Name, ShouldBeEmpty)
			So(fn.Results[0].Type.(IdentType).Ident, ShouldEqual, "error")
		})
		...
		Convey("Fact about MultiReturn", func() {
			...
			So(fn.Reciever, ShouldBeNil)
			So(len(fn.Parameters), ShouldEqual, 3)
			So(len(fn.Results), ShouldEqual, 3)
			So(fn.Parameters[0].Name, ShouldEqual, "a")
			So(fn.Parameters[0].Type.(IdentType).Ident, ShouldEqual, "int64")
			So(fn.Parameters[1].Name, ShouldEqual, "b")
			So(fn.Parameters[1].Type.(IdentType).Ident, ShouldEqual, "int64")
			So(fn.Parameters[2].Name, ShouldEqual, "c")
			So(fn.Parameters[2].Type.(IdentType).Ident, ShouldEqual, "int64")

			So(fn.Results[0].Name, ShouldEqual, "d")
			So(fn.Results[0].Type.(IdentType).Ident, ShouldEqual, "int64")
			So(fn.Results[1].Name, ShouldEqual, "e")
			So(fn.Results[1].Type.(IdentType).Ident, ShouldEqual, "string")
			So(fn.Results[2].Name, ShouldEqual, "f")
			So(fn.Results[2].Type.(IdentType).Ident, ShouldEqual, "error")
		})
		...
		Convey("Fact about String", func() {
			...
			So(len(fn.Results), ShouldEqual, 1)
			So(fn.Results[0].Name, ShouldBeEmpty)
			So(fn.Results[0].Type.(IdentType).Ident, ShouldEqual, "string")
		})
